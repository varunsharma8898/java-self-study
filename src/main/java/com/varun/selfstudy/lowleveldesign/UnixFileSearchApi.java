...
public class UnixFileSearchApi {
    ...
    /**
     * Entry         - interface
     * AbstractEntry - abstract class
     * FileEntry     - concrete class
     * DirEntry      - concrete class
     *
     * Filter        - interface
     * NameFilter    - impl
     * ExtensionFilter
     ...
     * ...
     *
     * FileSearcher  - uses queue + bfs to search passed in dir
     * SearchParams  - params to be used for searching/filtering
     *
     * */
}
