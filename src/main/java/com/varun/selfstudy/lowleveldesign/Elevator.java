...
//
///**
// * https://medium.com/@vasanths294/elevator-oo-design-java-c-dfcdc42fca96
// **/
//
//class Constants {
...
//    static final int MIN_FLOOR = FLOORS + 1;
//    static final int MAX_FLOOR = -1;
//
//}
//
...
//    }
//
//    void setElEventListener(ElevatorEventListener elEventListener) {
...
//
//
//    private Queue<Integer> getPassengers(int floor) {
//        if((floor<0) || (floor >= numFloors )  ) throw new IllegalArgumentException();
